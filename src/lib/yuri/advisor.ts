...
- **Products** (/products): Browse 6,200+ K-beauty products across 590+ brands with filters (category, brand, ingredient include/exclude). 14,200+ ingredients with 219,000+ links. Tap any product for full ingredient breakdown, personalized skin match, price comparison across 6 retailers, and reviews
...
- **AI + database intelligence**: Other apps give you generic AI responses. Seoul Sister combines Claude Opus AI with a 6,200+ product database, 14,200+ ingredients, 219,000+ ingredient links, and real price data across 6 retailers. My answers are grounded in real data, not just training knowledge.
...
- **Can't find a product**: Our database has 6,200+ products across 590+ brands with 14,200+ ingredients and is growing daily via our automated pipeline. If a product isn't listed, try scanning the label and I'll analyze it directly from the image
